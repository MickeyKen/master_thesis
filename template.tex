...
\begin{figure}[tbp]
	...
	\label{fig:right}}
	\subfigure[Dual Ubiquitous Display 3D model in the GAZEBO environment. Blue area indicates the range of LIDAR scanning.]{\includegraphics[width=9.3cm]{figs/dud_gazebo_environment.eps}
	\label{fig:bottom}}
	\end{center}
