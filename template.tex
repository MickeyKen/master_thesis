...
実機実験において，目標人物の検出を2D Lidarと魚眼カメラ(RGBカメラ)を用いて行った．180度のRGB情報が取得可能なELP社の魚眼カメラを採用した．本システムはRGB画像情報から目標人物の検出を行った後，目標人物の矩形内のLidarの値を脚の箇所と背景の箇所をkmeans法を用いた分離を行う．そして，両脚の位置を検出し人物の向きを推定する．Lidarの脚検出には，ROS公式のpeopleスタック\footnote{https://github.com/wg-perception/people}の一部であるleg\_detectorノードを用いた．また，RGB画像による人物の検出には，深層学習により人物や顔を検出するIntel OpenVinoパッケージ\footnote{https://github.com/intel/ros\_openvino\_toolkit}を利用して，本システムへの統合を行った．
